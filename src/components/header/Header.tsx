  ...
  const closeProfileDropdown = () => {
   ...
   return (
    <div className="relative">
            ...
            <div className="flex items-center space-x-6">
              <div className="flex space-x-6">
                ...
                <div className="relative group">
                  ...
                  />
                  {/* Tooltip */}
                  <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-1 bg-gray-800 text-white text-sm rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10">
                    Notifications
                  </div>
                </div>
                ...
                {/* Calendar Icon */}
                <div className="relative group">
                  <button onClick={toggleCalendar} className="hover:opacity-80 transition-opacity">
                    <img
                      src={calendar}
                      alt="Calendar icon"
                ...
                {/* Calculator Icon */}
                <div className="relative group">
                  <button onClick={toggleBudgetModal} className="hover:opacity-80 transition-opacity">
                    <img
                      src={calculator}
                      alt="Calculator icon"
                      className="h-6 w-auto cursor-pointer"
      ...
      <BudgetCalculatorModal isVisible={isBudgetModalVisible} onClose={closeBudgetModal} />
      
      {/* Profile Dropdown */}
      <ProfileDropdown isVisible={isProfileDropdownVisible} onClose={closeProfileDropdown} />
    </div>
  );
};
